...
# Scope
This event represents a request from a non-interop service to request that an interop service should load a resource
from the given tenant into the EMR authority.
